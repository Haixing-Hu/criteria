...
public final class SqlCriterionParserTest {
  ...
  public void testParseUnaryCriterion() throws ParsingException {
    ...
    final UnaryCriterion c3 = new UnaryCriterion("field1", UnaryOperator.NULL);
  ...
  public void testParseValueCriterion() throws ParsingException {
    ...
    final ValueCriterion c8 = new ValueCriterion("field1",
        BinaryOperator.NOT_EQUAL, "x");
    assertEquals(c8, parser.parse("field1\t!= \"x\""));
  }
  ...
  public void testParseCollectionCriterion() throws ParsingException {
    ...
    assertEquals(c4, parser.parse("field1 not In ( .10e-3 , \"x\\\\x\\\"yy\")"));
