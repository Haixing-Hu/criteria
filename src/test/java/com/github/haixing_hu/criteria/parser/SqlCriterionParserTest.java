...
public class SqlCriterionParserTest {
  ...
  public void testParseUnaryCriterion() throws ParsingException {
    ...
    final UnaryCriterion c2 = new UnaryCriterion("_field2", UnaryOperator.NOT_NULL);
    ...
    final UnaryCriterion c4 = new UnaryCriterion("_field2", UnaryOperator.NOT_NULL);
  ...
  public void testParseValueCriterion() throws ParsingException  {
    ...
    final ValueCriterion c3 = new ValueCriterion("field1",
        BinaryOperator.GREATER_EQUAL, Integer.valueOf(0xff));
    assertEquals(c3, parser.parse("field1 >= 255"));
